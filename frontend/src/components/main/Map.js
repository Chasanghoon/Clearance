...
>>>>>>> feat/FE/CSS_Gwangeun
  ...
  //               key={index}
  //               id={value.categoryId}
  //               style={{ borderRadius: "15px", fontSize: '15px', border: "0.1px solid black", backgroundColor: "beige", color: value.categoryId === categoryID ? "red" : "black" }}
  //               onClick={() => {
  //                 changeCategoryName(value.categoryName)
  //                 changeCategoryId(value.categoryId)
  //               }}>{value.categoryName}</button>

  //             <hr style={{display: (index > 0 && (index + 1) % 3 === 0) ? "block" : "none", margin: "0px 0px 0px 0px"}} />
  //           </span>
  //         ))}
  //     </div>)
  // }
